...
set ::env(VERILOG_FILES) "\
	...
	$::env(CARAVEL_ROOT)/../verilog/rtl/PatmosChip.v \
	$::env(CARAVEL_ROOT)/../verilog/rtl/BlackBoxRom.v \
	$::env(CARAVEL_ROOT)/../verilog/rtl/user_project_wrapper.v \
	$::env(CARAVEL_ROOT)/../verilog/rtl/HelloMorse.v"
...
set ::env(GLB_RESIZER_HOLD_SLACK_MARGIN) 1.4
set ::env(PL_RESIZER_HOLD_SLACK_MARGIN) 1.4
